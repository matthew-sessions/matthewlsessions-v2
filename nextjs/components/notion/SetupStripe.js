            ...
            <div className=" max-w-[1300px] m-auto pt-12  pb-12">
                ...
                <div className="flex flex-wrap md:flex-row-reverse mt-2">
                    <div className=" w-full md:w-6/12">
                        <iframe className="w-full h-[300px] md:h-[500px]" src="https://www.youtube.com/embed/pcF6sEY8Whw" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                    </div>
