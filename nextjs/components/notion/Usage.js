    ...
    return (
        <div className=" w-full bg-slate-400">
            <div className=" max-w-[1300px] m-auto pt-12 pb-12">
                ...
                <iframe className="w-full h-[300px]  px-2 md:px-0 md:h-[700px]" src="https://www.youtube.com/embed/pcF6sEY8Whw" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
            </div>
        </div>
    )
};